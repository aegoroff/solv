...
mod tests {
    ...
    #[test_case(&REAL_SOLUTION_WITH_STRING_IN_VERSION.trim_end() ; "trimmed from end real solution with string in version")]
...
"#;
    ...
    const REAL_SOLUTION_WITH_STRING_IN_VERSION: &str = r#"
Microsoft Visual Studio Solution File, Format Version 12.00
